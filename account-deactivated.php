...
<head>
    ...
    <title>Account Deactivated - Bright Steps</title>
...
<body>
    <div class="status-page">
        ...
        <div class="status-card">
            ...
            <h1 class="status-title">Account Deactivated</h1>
            <p class="status-desc">
                Your clinic account has been deactivated. 
            ...
            <div class="info-box">
                ...
                <p class="info-box-text">While your account is deactivated, you cannot access any platform features. 
                   If you wish to restore your access, please contact our support team.</p>
            </div>

            <div class="status-actions">
                <a href="mailto:support@brightsteps.com?subject=Account%20Reactivation" class="btn-support">
