 ...
 * 
 * Endpoints:
 *   GET ?action=child          — Get full medical history for a child
 *   GET ?action=appointments   — Get all clinic appointments with filters
 *   GET ?action=search         — Search children across the clinic
 */
