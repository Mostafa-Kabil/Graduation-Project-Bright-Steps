        ...
        if ($user) {
            if (password_verify($password, $user['password'])) {
                if ($user['status'] == 'pending') {
                    $errors[] = "Your clinic is pending approval. You will receive an email once approved.";
                } else {
...
<body>
    <div class="auth-page auth-split-layout">
        <div class="auth-form-side">
            <button class="back-button" onclick="navigateTo('for-clinics')" style="position: absolute; top: 1.5rem; left: 1.5rem;">
            ...
            <div class="auth-container">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <span class="clinic-badge-small">Clinic Portal</span>
                        <h1 class="auth-title">Welcome back!</h1>
                        <p class="auth-subtitle">Log in to manage your clinic dashboard</p>
                    </div>

                    <form novalidate id="clinic-login-form" method="POST" class="auth-form">
                ...
                ?>" placeholder="••••••••" required>
                            ...
                            <?php foreach ($errors as $error): ?>
                                <?php if (strpos($error, 'pending') !== false): ?>
                                    <p class="error-message" style="color: #f59e0b;"><?php echo htmlspecialchars($error); ?></p>
                                    <?php break; ?>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="modern-auth-footer">
                        <p class="auth-footer-text">
                            ...
                            <a href="clinic-signup.php" class="auth-link font-semibold">Register Clinic</a>
                        </p>
    ...
    <div class="forgot-overlay" id="forgot-modal">
        <div class="forgot-card" style="position:relative;">
            ...
            <div class="forgot-steps active" id="forgot-step1">
                ...
                <p>Enter your clinic email and we'll send you a reset code.</p>
                <input type="email" class="forgot-input" id="forgot-email" placeholder="admin@clinic.com">
