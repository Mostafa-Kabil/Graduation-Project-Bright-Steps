...
try {
    ...
    if ($pointsToAward > 0) {
        ...
        // Log to parent_points_tracking
        try {
            $connect->prepare("INSERT INTO parent_points_tracking (parent_id, child_id, action, points, reason) VALUES (?, ?, 'Growth Entry', ?, 'Recorded growth measurements')")->execute([$parentId, $childId, $pointsToAward]);
